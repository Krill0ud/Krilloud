...
<!-- Inputs-->
      <div class="col-1 input" :class="$helper.socketConnectedClass(inputAudio.connections, inputAudio.socket.name)">
...
export default {
  ...
  computed: {
    ...
    frequency: {
      ...
      set (v) {
        this.$store.dispatch('main/setFilterParameter', { id: 2, value: v, tagname: this.currentTagName, idNode: this.idNode, name: 'frequency', prevValue: this.datafilter.frequency.value })
